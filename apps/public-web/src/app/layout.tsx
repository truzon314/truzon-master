...
import { FOOTER_COLUMNS, MAIN_NAV } from "@/lib/constants/navigation";
...
async function getNavData() {
  try {
    ...
    const cmsColumns = [
      ...
      footerProperties && footerProperties.items.length > 0
    ...
    return {
      mainNav: headerMenu && headerMenu.items.length > 0
        ? toNavLinks(headerMenu.items)
        : MAIN_NAV,

      footerColumns: cmsColumns.length > 0 ? cmsColumns : FOOTER_COLUMNS,
