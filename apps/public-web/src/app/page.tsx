  ...
  slides: [
    {
      ...
      image_url: "/images/extracted/hero-villa-street.jpg",
      mobile_image_url: "/images/extracted/hero-villa-street.jpg",
    },
    {
      heading: "Master-Planned Luxury Townships",
      subheading:
        "Expansive green corridors, world-class amenities, and timeless urban master-planning designed for multi-generational community living.",
      image_url: "/images/extracted/hero-township-aerial.jpg",
      mobile_image_url: "/images/extracted/hero-township-aerial.jpg",
    },
    {
      heading: "Private Estates & Signature Villas",
      subheading:
        "Floor-to-ceiling glass pavilions, private infinity pools, and handcrafted finishes crafted to the highest international standards of luxury.",
      image_url: "/images/extracted/hero-villa-twilight.jpg",
      mobile_image_url: "/images/extracted/hero-villa-twilight.jpg",
    },
  ],
};
...
export default async function Home() {
  ...
  const properties = propertyItems.length > 0 ? propertyItems.map(toProperty) : PROPERTIES;
